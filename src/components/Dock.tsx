  ...
  return (
    <div className="dock">
      <div className="dock-status">
        ...
        <span className="label">Remote · Open to work</span>
      </div>

      <div className="dock-socials">
        <a href="https://github.com/paul-andrei-jison" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        <a href="https://www.linkedin.com/in/paul-andrei-jison-55213a321/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
